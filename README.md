...
├── views/
│   ├── header.ejs          # ส่วนหัวของหน้า (พร้อม Google Fonts)
...
└── public/
    └── styles.css          # CSS Styles (Sukhumvit Set Font)
```
...
- **Padding**: 30px 25px 35px (ล่างเพิ่มเพื่อป้องกัน text ทับกัน)
- **Card Link**: แสดงแบบ inline-block ด้านล่างสุด ไม่ใช้ absolute position
- **Spacing**: margin-bottom 15px หลังข้อความประเภทข้อมูล

### Typography
- **Font Family**: Sukhumvit Set (Google Fonts)
- **Line Heights**:
  - Body: 1.6
  - Headings (h1): 1.3
  - Paragraphs: 1.5
...
- **Text**: #333 (dark), #555 (medium), #777 (light)
- **White**: #ffffff (cards, forms)

### Components
- **Buttons**: Gradient primary, gray secondary, yellow edit, red delete
- **Tables**: Gradient header, hover effects on rows
- **Forms**: 2px border, focus state with shadow
- **Badges**: Gradient background, rounded corners
- **Navigation**: Sticky top, white background with shadow
...
1. **หน้าแรก** - แสดง Dashboard สรุปจำนวนข้อมูล (Card layout พร้อม link "ดูทั้งหมด")
